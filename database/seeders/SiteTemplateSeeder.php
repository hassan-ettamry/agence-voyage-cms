        ...
        return [
            $this->page('Home', 'home', 'Thoughtful journeys, designed around you', [
                $this->node('search-hero', [
                    ...
                    'description' => 'Tailor-made journeys shaped by local knowledge, thoughtful pacing and the way you want to travel.',
                ...
                $this->node('image-text', [
                    ...
                    'title' => 'Your journey should feel like your own',
                    'text' => 'We begin with the places, experiences and pace that matter to you. Then our local experts shape every detail into a journey with character, comfort and room for discovery.',
                    'image' => '/images/site-templates/culture-journey.png',
                    'imageAlt' => 'A meaningful cultural journey designed by local experts',
                    'imagePosition' => 'right',
                    'buttonText' => 'How we design journeys',
                    'url' => '/about',
                ]),
                $this->node('destination-carousel', [
                    'eyebrow' => 'FEATURED DESTINATIONS',
                    'title' => 'Places that stay with you',
                    'intro' => 'Handpicked places with the character, culture and experiences that make a journey memorable.',
                    'limit' => 4,
                    'source' => 'featured',
                    'showViewAll' => 'yes',
                ...
                $this->node('special-offers', [
                    ...
                    'intro' => 'Distinctive itineraries selected by our travel designers and ready to be shaped around you.',
                    'limit' => 3,
                    'columns' => 3,
                    'imageRatio' => '4/3',
                    'showViewAll' => 'yes',
            ...
            $this->catalogPage('Offers', 'offers', '/offers', 'Curated journeys and special offers', [
                ...
                $this->node('offer-comparison', [
                    ...
                    'intro' => 'Compare destination, duration and price before opening the full day-by-day itinerary.',
                    'limit' => 3,
